!(function () {
        ...
        Ct = {
            f: u
                ? Pt
                    ? function (t, e, r) {
                          if (
                              (kt(t), (e = bt(e)), kt(r), 'function' == typeof t && 'prototype' === e && 'value' in r && Nt in r && !r[Nt])
                          ) {
                              var n = Mt(t, e);
                              n &&
                                  n[Nt] &&
    ...
    var re,
            ...
            var e = zt.CONFIGURABLE,
                ...
                p = (t.exports = function (t, n, a) {
                    ('Symbol(' === s(o(n), 0, 7) && (n = '[' + c(o(n), /^Symbol\(([^)]*)\).*$/, '$1') + ']'),
                        a && a.getter && (n = 'get ' + n),
                        a && a.setter && (n = 'set ' + n),
                        (!ut(t, 'name') || (e && t.name !== n)) && (u ? i(t, 'name', { value: n, configurable: !0 }) : (t.name = n)),
        ...
        ie = function (t, e, r, n) {
            ...
            if ((T(r) && oe(r, i, n), n.global)) o ? (t[e] = r) : et(e, r);
                ...
                o ? (t[e] = r) : Ct.f(t, e, { value: r, enumerable: !1, configurable: !n.nonConfigurable, writable: !n.nonWritable });
            }
            return t;
        },
        ae = Math.ceil,
    ...
    var Sr =
        ...
        xr = function (t, e) {
            return new ((function (t) {
                var e;
                return (
                    ur(t) && ((Sr((e = t.constructor)) && (e === Or || ur(e.prototype))) || (M(e) && null === (e = e[Er]))) && (e = void 0),
                    void 0 === e ? Or : e
                );
            })(t))(0 === e ? 0 : e);
        },
        ...
        Pr = function (t) {
            ...
            return function (s, c, f, l) {
                for (
                    var h, p, v = it(s), d = R(v), g = de(d), y = ar(c, f), m = 0, b = l || xr, w = e ? b(s, g) : r || a ? b(s, 0) : void 0;
                    g > m;
                    m++
                )
        ...
        Ar = { forEach: Pr(0), map: Pr(1), filter: Pr(2), some: Pr(3), every: Pr(4), find: Pr(5), findIndex: Pr(6), filterReject: Pr(7) },
        jr = Ar.find,
        kr = 'find',
        Ir = !0;
    (kr in [] &&
        ...
        { target: 'Array', proto: !0, arity: 1, forced: gl },
        {
            concat: function (t) {
                ...
                for (e = -1, n = arguments.length; e < n; e++)
                    if (dl((i = -1 === e ? a : arguments[e]))) for (o = de(i), Nr(s + o), r = 0; r < o; r++, s++) r in i && Cn(u, s, i[r]);
    ...
    var kp = Object.getOwnPropertyDescriptor,
        ...
        wv = function (t) {
            ((this.entries = []),
                (this.url = null),
                void 0 !== t &&
                    (M(t) ? this.parseObject(t) : this.parseQuery('string' == typeof t ? ('?' === tv(t, 0) ? uv(t, 1) : t) : Wr(t))));
        };
    wv.prototype = {
        type: Bp,
        bindURL: function (t) {
        ...
        parse: function (t, e, r) {
            ...
            for (
                ...
                switch (((o = n[f]), c)) {
                            ...
                            if (
                                ('..' === (u = Id((u = l))) || '%2e.' === u || '.%2e' === u || '%2e%2e' === u
                                    ...
                                    : rg(l)
                                      ...
                                      : ('file' === s.scheme && !s.path.length && tg(l) && (s.host && (s.host = ''), (l = wd(l, 0) + ':')),
                                        Rd(s.path, l)),
                                (l = ''),
                    ...
                    case Eg:
                        e || '#' !== o
                            ? o !== Wv && ("'" === o && s.isSpecial() ? (s.query += '%27') : (s.query += '#' === o ? '%23' : Qd(o, Vd)))
                            : ((s.fragment = ''), (c = Og));
                        break;
                    case Og:
    ...
    if (
        ...
        ((Ky = function (t) {
            hm(this, { type: um, done: !1, notified: !1, parent: !1, reactions: new Ny(), rejection: !1, state: 0, value: null });
