(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
                        ...
                        function (t, e, i) {
                            ...
                            ((l.prototype.getEdges = function () {
                                ...
                                (l.prototype.scatter = function () {
                                    ...
                                    ((e = s.WORLD_CENTER_Y + a.nextDouble() * (o - n) + n), (this.rect.x = t), (this.rect.y = e));
                                }),
                                ...
                                (l.prototype.transform = function (t) {
                                    var e = this.rect.x;
                                    e > s.WORLD_BOUNDARY ? (e = s.WORLD_BOUNDARY) : e < -s.WORLD_BOUNDARY && (e = -s.WORLD_BOUNDARY);
                                    var i = this.rect.y;
                                    i > s.WORLD_BOUNDARY ? (i = s.WORLD_BOUNDARY) : i < -s.WORLD_BOUNDARY && (i = -s.WORLD_BOUNDARY);
                                    var r = new h(e, i),
                            ...
                            ((c.prototype.getNodes = function () {
                                ...
                                (c.prototype.remove = function (t) {
                                    if (t instanceof a) {
                                        ...
                                        (e.source.edges.splice(s, 1), e.target != e.source && e.target.edges.splice(l, 1));
                                ...
                                (c.prototype.updateLeftTop = function () {
                                    for (
                                        var t, e, i, r = n.MAX_VALUE, o = n.MAX_VALUE, s = this.getNodes(), a = s.length, h = 0;
                                        h < a;
                                        h++
                                    ) {
                                        var l = s[h];
                                    ...
                                    return r == n.MAX_VALUE
                                        ? null
                                        : ((i = void 0 != s[0].getParent().paddingLeft ? s[0].getParent().paddingLeft : this.margin),
                                          (this.left = o - i),
                                          (this.top = r - i),
                                ...
                                (c.prototype.updateBounds = function (t) {
                                    ...
                                    (a == n.MAX_VALUE &&
                                        ...
                                        (s = void 0 != c[0].getParent().paddingLeft ? c[0].getParent().paddingLeft : this.margin),
                                        (this.left = y.x - s),
                            ...
                            ((o.prototype.addRoot = function () {
                                ...
                                (o.prototype.remove = function (t) {
                                    if (t instanceof r) {
                                        ...
                                        for (var e, i, o = [], s = (o = o.concat(t.getEdges())).length, a = 0; a < s; a++)
                                            ((e = o[a]), t.remove(e));
                                        var h = [];
                                ...
                                (o.prototype.includesInvalidEdge = function () {
                                    for (var t, e = this.edges.length, i = 0; i < e; i++)
                                        if (((t = this.edges[i]), this.isOneAncestorOfOther(t.source, t.target))) return !0;
                                    return !1;
                                }),
                                (t.exports = o));
                        },
                                    ...
                                    if (r === o)
                                        ...
                                        if (
                                            (-O === D
                                                ...
                                                : O === D && (r > o ? ((i[0] = a), (i[1] = h)) : ((i[0] = c), (i[1] = u)), (L = !0)),
                                            -I === D
                                                ? (o > r ? ((i[2] = v), (i[3] = A)) : ((i[2] = E), (i[3] = y)), (m = !0))
                                                : I === D && (o > r ? ((i[2] = f), (i[3] = y)) : ((i[2] = T), (i[3] = A)), (m = !0)),
                                            L && m)
                                        )
                                            return !1;
                                        if (
                                            (r > o
                                                ? n > s
                                                    ? ((w = this.getCardinalDirection(O, D, 4)), (R = this.getCardinalDirection(I, D, 2)))
                                                    : ((w = this.getCardinalDirection(-O, D, 3)), (R = this.getCardinalDirection(-I, D, 1)))
                                                : n > s
                                                  ? ((w = this.getCardinalDirection(-O, D, 1)), (R = this.getCardinalDirection(-I, D, 3)))
                                                  : ((w = this.getCardinalDirection(O, D, 2)), (R = this.getCardinalDirection(I, D, 4))),
                                            !L)
                                        )
                                            switch (w) {
                                                case 1:
                        ...
                        function (t, e, i) {
                            ...
                            ((h.prototype.initParameters = function () {
                                ...
                                (h.prototype.calcIdealEdgeLengths = function () {
                                    for (var t, e, i, r, s, a, h = this.getGraphManager().getAllEdges(), l = 0; l < h.length; l++)
                                ...
                                (h.prototype.calcRepulsionForces = function () {
                                    ...
                                    if (this.useFRGridVariant)
                                        for (
                                            this.totalIterations % n.GRID_CALCULATION_CHECK_PERIOD == 1 && s && this.updateGrid(),
                                                o = new Set(),
                                                t = 0;
                                            t < h.length;
                                            t++
                                ...
                                (h.prototype.calcRepulsionForce = function (t, e) {
                                    var i,
                                        ...
                                        f = [, , , ,];
                                    if (c.intersects(d)) {
                                        (s.calcSeparationAmount(c, d, p, n.DEFAULT_EDGE_LENGTH / 2), (g = 2 * p[0]), (u = 2 * p[1]));
                                        ...
                                        (this.uniformLeafNodeSizes && null == t.getChild() && null == e.getChild()
                                            ? ((i = d.getCenterX() - c.getCenterX()), (r = d.getCenterY() - c.getCenterY()))
                                            ...
                                            (g = ((l = (this.repulsionConstant * t.noOfChildren * e.noOfChildren) / o) * i) / h),
                                            (u = (l * r) / h),
                                            (t.repulsionForceX -= g),
                                            (t.repulsionForceY -= u),
                                            (e.repulsionForceX += g),
                                ...
                                (h.prototype.calcGravitationalForce = function (t) {
                                    ...
                                    ((i = ((e = t.getOwner()).getRight() + e.getLeft()) / 2),
                                        ...
                                        t.getOwner() == this.graphManager.getRoot()
                                            ...
                                            : (s > (h = e.getEstimatedSize() * this.compoundGravityRangeFactor) || a > h) &&
                                ...
                                (h.prototype.addNodeToGrid = function (t, e, i) {
                                    ...
                                    ((r = parseInt(Math.floor((t.getRect().x - e) / this.repulsionRange))),
                                        ...
                                        (s = parseInt(Math.floor((t.getRect().height + t.getRect().y - i) / this.repulsionRange))));
                                    for (var a = r; a <= n; a++)
                                        for (var h = o; h <= s; h++) (this.grid[a][h].push(t), t.setGridCoordinates(r, n, o, s));
                                }),
                            ...
                            ((v.prototype.newGraphManager = function () {
                                        ...
                                        if (!e.has(i)) {
                                            ...
                                            if (r == n)
                                                ...
                                                var o,
                                                    ...
                                                    a = [];
                                                if (
                                                    ((a = (a = a.concat(r.getEdgeListToNode(n))).concat(n.getEdgeListToNode(r))),
                                                    !e.has(a[0]))
                                                ) {
                                                    if (a.length > 1)
                                                        for (s = 0; s < a.length; s++) {
                                                            var h = a[s];
                                                            (h.getBendpoints().push(new c()), this.createDummyNodesForBendpoints(h));
                                                        }
                                ...
                                (v.prototype.positionNodesRadially = function (t) {
                                    for (
                                        ...
                                        a % i == 0 && ((o = 0), (n = r), 0 != a && (n += h.DEFAULT_COMPONENT_SEPERATION), (r = 0));
                                        var l = t[a],
                                ...
                                (v.prototype.groupZeroDegreeMembers = function () {
                                    ...
                                    for (var i = [], r = this.graphManager.getAllNodes(), n = 0; n < r.length; n++) {
                                        var o = r[n],
                                            a = o.getParent();
                                        0 !== this.getNodeDegreeWithChildren(o) || (void 0 != a.id && this.getToBeTiled(a)) || i.push(o);
                                    }
                                ...
                                (v.prototype.insertNodeToRow = function (t, e, i, r) {
                                    ...
                                    var s = 0;
                                    (o > t.rowHeight[i] && ((s = t.rowHeight[i]), (t.rowHeight[i] = o), (s = t.rowHeight[i] - s)),
                                        (t.height += s),
                                        t.rows[i].push(e));
                                }),
                                ...
                                (v.prototype.canAddHorizontal = function (t, e, i) {
                                    ...
                                    return (
                                        ...
                                        (n = t.width < e ? (t.height + a) / e : (t.height + a) / t.width) < 1 && (n = 1 / n),
                                        r < 1 && (r = 1 / r),
                                        r < n
                                    );
                                }),
                                    ...
                                    for (var t, e = [], i = !0; i; ) {
                                        ...
                                        if (!0 == i) {
                                            for (var s = [], a = 0; a < n.length; a++)
                                                1 == n[a][0].getEdges().length && (s.push(n[a]), n[a][0].getOwner().remove(n[a][0]));
                                ...
                                (v.prototype.findPlaceforPrunedNode = function (t) {
                                    var e,
                                        ...
                                        g = i.finishY,
                                        u = [0, 0, 0, 0];
                                    if (h > 0) for (var c = s; c <= a; c++) u[0] += this.grid[c][h - 1].length + this.grid[c][h].length - 1;
                                    if (a < this.grid.length - 1)
                                        for (var c = h; c <= g; c++) u[1] += this.grid[a + 1][c].length + this.grid[a][c].length - 1;
                                    if (g < this.grid[0].length - 1)
                                        for (var c = s; c <= a; c++) u[2] += this.grid[c][g + 1].length + this.grid[c][g].length - 1;
                                    if (s > 0) for (var c = h; c <= g; c++) u[3] += this.grid[s - 1][c].length + this.grid[s][c].length - 1;
                                    ...
                                    0 == e
                                        ? o.setCenter(
                                              i.getCenterX(),
                                              i.getCenterY() - i.getHeight() / 2 - l.DEFAULT_EDGE_LENGTH - o.getHeight() / 2
                                          )
                                        : 1 == e
                                          ? o.setCenter(
                                                i.getCenterX() + i.getWidth() / 2 + l.DEFAULT_EDGE_LENGTH + o.getWidth() / 2,
                                                i.getCenterY()
                                            )
                                          : 2 == e
                                            ? o.setCenter(
            ...
            (e.exports = (function (t) {
                var e = [
                        ...
                        function (t, e, i) {
                            ...
                            var c = function (t) {
                                (null != t.nodeRepulsion && (o.DEFAULT_REPULSION_STRENGTH = n.DEFAULT_REPULSION_STRENGTH = t.nodeRepulsion),
                                    null != t.idealEdgeLength && (o.DEFAULT_EDGE_LENGTH = n.DEFAULT_EDGE_LENGTH = t.idealEdgeLength),
                                    null != t.edgeElasticity && (o.DEFAULT_SPRING_STRENGTH = n.DEFAULT_SPRING_STRENGTH = t.edgeElasticity),
                                    null != t.nestingFactor &&
                                        (o.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = n.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = t.nestingFactor),
                                    null != t.gravity && (o.DEFAULT_GRAVITY_STRENGTH = n.DEFAULT_GRAVITY_STRENGTH = t.gravity),
                                    ...
                                    null != t.gravityCompound &&
                                        (o.DEFAULT_COMPOUND_GRAVITY_STRENGTH = n.DEFAULT_COMPOUND_GRAVITY_STRENGTH = t.gravityCompound),
                                    ...
                                    'draft' == t.quality ? (r.QUALITY = 0) : 'proof' == t.quality ? (r.QUALITY = 2) : (r.QUALITY = 1),
                                    ...
                                    (o.DEFAULT_INCREMENTAL = n.DEFAULT_INCREMENTAL = r.DEFAULT_INCREMENTAL = !t.randomize),
                            ...
                            ((u.prototype.run = function () {
                                ...
                                ((this.root = o.addRoot()), this.processChildrenList(this.root, this.getTopMostNodes(a), r));
                                for (var l = 0; l < h.length; l++) {
                                    var g = h[l],
                                        u = this.idToLNode[g.data('source')],
                                        c = this.idToLNode[g.data('target')];
                                    u !== c && 0 == u.getEdgesBetween(c).length && (o.add(r.newEdge(), u, c).id = g.id());
                                }
                                var d = function (t, e) {
                                        'number' == typeof t && (t = e);
                                        var i = t.data('id'),
                                    ...
                                    p = function o() {
                                        ...
                                        (i.eles.nodes().positions(function (t, e) {
                                            if (('number' == typeof t && (t = e), !t.isParent())) {
                                                ...
                                                return null != r ? { x: r.x, y: r.y } : { x: t.position('x'), y: t.position('y') };
                                            }
                                        }),
                                            a(),
                                ...
                                return (
                                    ...
                                    'during' !== this.options.animate &&
                                        (n.options.eles.nodes().not(':parent').layoutPositions(n, n.options, d), (t = !1)),
                                    this
                                );
                            }),
                                ...
                                (u.prototype.processChildrenList = function (t, e, i) {
                                    for (var r = e.length, n = 0; n < r; n++) {
                                        ...
                                        ((this.idToLNode[g.data('id')] = o),
                                            ...
                                            null != u &&
                                                u.length > 0 &&
                                                ((s = i.getGraphManager().add(i.newGraph(), o)), this.processChildrenList(s, u, i)));
                                    }
                                }),
    ...
    t => {
        ...
        function o(t, e) {
            t.forEach(t => {
                let i = { id: t.id, labelText: t.label, height: t.height, width: t.width, padding: t.padding ?? 0 };
        ...
        function a(t) {
            return new Promise(r => {
                let a = (0, n.select)('body').append('div').attr('id', 'cy').attr('style', 'display:none'),
                    h = (0, i.default)({
                ...
                (a.remove(),
                    ...
                    h.ready(t => {
                        (e.log.info('Cytoscape ready', t), r(h));
                    }));
            });
        }
        function h(t) {
        ...
        async function g(t, i) {
            ...
            try {
                ...
                let i = await a(t),
                    r = h(i),
                    n = l(i);
                return (e.log.debug(`Layout completed: ${r.length} nodes, ${n.length} edges`), { nodes: r, edges: n });
            } catch (t) {
        ...
        (i.default.use(r.default),
            (0, e.__name)(o, 'addNodes'),
            (0, e.__name)(s, 'addEdges'),
            (0, e.__name)(a, 'createCytoscapeInstance'),
            (0, e.__name)(h, 'extractPositionedNodes'),
            (0, e.__name)(l, 'extractPositionedEdges'),
            (0, e.__name)(g, 'executeCoseBilkentLayout'),
            (0, e.__name)(u, 'validateLayoutData'));
        var c = (0, e.__name)(
            async (
                t,
                e,
                { insertCluster: i, insertEdge: r, insertEdgeLabel: n, insertMarkers: o, insertNode: s, log: a, positionEdgeLabel: h },
                { algorithm: l }
            ) => {
                let u = {},
                    c = {},
