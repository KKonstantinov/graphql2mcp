...
<div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
    <a href="https://www.npmjs.com/package/graphql2mcp">
        <img src="https://img.shields.io/npm/v/graphql2mcp" alt="npm version" />
    </a>
</div>

**[Documentation](https://graphql2mcp.vercel.app/docs/cli)**

Standalone CLI proxy that converts GraphQL endpoints into MCP (Model Context Protocol) servers. Point it at a GraphQL endpoint and get an
MCP server with tools mapped from queries and mutations.
